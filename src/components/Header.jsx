...
function Header(){
    return (
        <div className="h-24  flex items-center bg-black mt-0 sticky z-50" >
            <img className="w-24 ml-5 mr-5 mt-4 object-contain" src="https://pngimg.com/uploads/amazon/amazon_PNG11.png"></img>
            ...
            <div className="flex justify-between ">
                ...
                <div className="flex ml-3 mr-3 text-white flex-row">
                    <ShoppingBasketIcon className="flex items-cente mr-2 text-white"/>
